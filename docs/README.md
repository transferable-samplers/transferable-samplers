...
A research codebase for **sampling the Boltzmann density of molecular systems**, with focus on transferable methods that generalise to unseen systems at inference time.
> **Note:** This is a research codebase, not a library. It is designed to be edited and hacked for rapid prototyping of novel approaches.
...
For full usage including datasets, model weights, training, and fine-tuning, see [Usage](usage.md).
